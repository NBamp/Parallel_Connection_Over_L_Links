...
def main():
    ...
    while True:
        ...
        R_i = [] #Lost source packets per frame
            ...
            for channel in channels:
                ...
                if start < encoder.rank:
                    ...
                    if not R_i or R_i[block_frame-1] == 0:
                        ...
                        uncoded_packets_based_on_algorithm , coded_packets_based_on_algorithm = computing_condition(R_i[block_frame-1],channel.throughput, min_throughput , channel.capacity, channel.loss_probability)
                        end += uncoded_packets_based_on_algorithm

                    if end > encoder.rank:
                        end = end - encoder.rank
                ...
                assert  (successfully_transmitted_packets_per_channel + loss_packets_per_channel) == channel.capacity
